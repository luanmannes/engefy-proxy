...
exports.handler = async (event) => {
      ...
      try {
          ...
          // bulk-data endpoints have their own version path (e.g. /bulk-data/v1/outcome)
          // so we use the root base to avoid duplicating /v1
          const base = endpoint.startsWith('/bulk-data') ? SIENGE_BASE_ROOT : SIENGE_BASE;
